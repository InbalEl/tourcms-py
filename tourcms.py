...
class Connection(object):
  ...
  def _generate_signature(self, path, verb, channel, outbound_time):
    ...
    dig = hmac.new(self.private_key.encode('utf8'),
                   ...
                   hashlib.sha256)
    b64 = base64.b64encode(dig.digest()) # b64encode takes bytes, not str
  ...
  # todo: Managing dates & prices externally
  # search_raw_departures
  # show_departure
  # create_new_departure
  # update_departure
  # delete_departure
  ...
  # Bookings
  # todo: Creating bookings
  # list_bookings
  # search_bookings
  # show_booking
  # update_booking
  # update_booking_component
  # add_booking_component
  # remove_booking_component
  # add_note_to_booking
  # send_booking_email
  # cancel_booking
